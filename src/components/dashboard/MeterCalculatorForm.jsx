    ...
    >
      <div
        className={`px-5 py-4 border-b ${
          isDark
            ? "border-slate-700 bg-gradient-to-r from-violet-950/80 to-cyan-950/80"
            : "border-slate-100 bg-gradient-to-r from-slate-50 to-slate-100/80"
        }`}
      >
      ...
      <div className="flex flex-col gap-4 p-5 sm:flex-row sm:flex-wrap sm:items-end">
        {showBaseField && (
          <div>
            <label className={`mb-2 block text-xs font-semibold uppercase ${isDark ? "text-slate-400" : "text-slate-600"}`}>
            ...
            <input
              ...
              className={`w-full rounded-xl border px-4 py-3 font-bold tabular-nums outline-none sm:w-40 ${
                isDark
        ...
        <div className="min-w-0 flex-1 sm:max-w-xs">
          ...
          <input
            ...
            className={`w-full rounded-xl border px-4 py-3 text-lg font-bold tabular-nums outline-none ${
              isDark
                ? "border-slate-600 bg-slate-800 text-white"
                : "border-slate-200 bg-white text-slate-900"
            }`}
